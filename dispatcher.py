  ...
  def dispatch(self):
    while len(self.filas.filaGeral) > 0 or len(self.filas.fila1) > 0 or len(self.filas.fila2) > 0 or len(self.filas.fila3) > 0:
      while len(self.filas.filaReal) > 0:
        ...
        while(j < len(self.reader.operations)):
          if(int(self.reader.operations[j][0]) == proc.id):
            op = self.reader.operations.pop(j)
      ...
      while len(self.filas.fila1) > 0:
        ...
        print("\n")
        while(j < len(self.reader.operations)):
          if(int(self.reader.operations[j][0]) == proc.id and turn):
            turn = False
            if (proc.opTotal < proc.processor):
              ...
              while (proc.opTotal != numOperacao):
                ...
                if(proc.opTotal >= proc.processor):
                  proc.opTotal += 1
                  for x in self.reader.operations:
                    if(int(x[0]) == proc.id):
                      self.reader.operations.remove(x)
